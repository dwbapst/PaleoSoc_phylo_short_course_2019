...
collected from living and fossil cinctans (family Ursidae).
...
[[`cinctans_taxa.tsv`]{}]{} file using the [[`readTaxonData()`]{}]{}
function.
...
Fig. 3) of cinctans, and we will specify a uniform
...
provided in the file [[`cinctans_fossil_intervals.tsv`]{}]{}. First, we
...
the age of the MCRCA of living cinctans ([[`age_extant`]{}]{}), the number
...
components as arguments. This step may give you quite a bit of output. As a convenience, we have not shown this here.
...
Open [Tracer]{} and import the [[`cinctans.log`]{}]{} file in the
...
[***Posterior***]{} statistic for the [[`cinctans.log`]{}]{} file in the
[[`output`]{}]{} directory.
...
age of the MRCA for all living cinctans?
...
Read in the MCMC sample of trees from file.
    ...
    trace = readTreeTrace("output/cinctans.trees")
...
credibility (MSACC) tree [@Gavryushkina2016].
    ...
    mccTree(trace, file="output/cinctans.mcc.tre" )
...
[[`output/cinctans.mcc.tre`]{}]{} in [IcyTree]{}.
