...
range data from the fossil record [@Ronquist2012a, @Zhang2016, @Gavryushkina2016]. 
...
the exercise demonstrating how to apply these models in
...
collected from an entirely extinct clade of Cinctans.


## Introduction 

The "combined-evidence" analysis described in this tutorial uses a
probabilistic graphical model [@Hoehna2014b] integrating two separate
likelihood components or data partitions (Fig. 1): one for
...
*fossilized birth-death* (FBD) process [@Stadler2010, @Heath2014, @Stadler2018]. This
...
Fig. 1. The fossilized birth-death process provides a
...
fossils or viruses). This type of tree is shown in Fig. 2. 
...
approaches described by Ronquist [@Ronquist2012a] and extended by Zhang [@Zhang2016] and
Gavryushkina [@Gavryushkina2016]. When matrices of discrete morphological characters
