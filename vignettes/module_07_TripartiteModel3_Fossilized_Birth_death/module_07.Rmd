...
David Bapst <dwbapst@tamu.edu>
	
AttachmentsTue, Sep 10, 2:10 PM (6 days ago)
	
to Sandy, David, Peter, April, Laura, William
Here's mine - the question that has long driven me in paleontology is
this damn figure from a book chapter that Chuck wrote about the
Ordovician-Silurian mass extinction (Mitchell, 1990), showing the
convergence between the late Ordovician diplograptids and the Silurian
neograptids. The recurrent morphotypes are a common feature of many
fossil records, not just graptolites, but the key to understanding the
evolutionary drivers, not just the biomechanical or functional drivers
that lead to such iterative evolution is only possible if we have
good, dated phylogenies that we can use for complex comparative
analyses that let us test for multi-peaked adaptive landscapes. But
I'm not convinced yet that we can do all that in the fossil record...
yet.
