...
![*Sandra Carlson*](files/sandy_carlson.jpg){#id .class width=55% height=55%}
...
![*Peter Wagner at home...*](files/Peter_Took.jpg){#id .class width=35% height=35%}

Pete’s interest in phylogenetic methods stem the twin goals of deriving better phylogenetic methods for supposedly character-poor systems such as gastropod shells and finding tree-based approaches that simultaneously assess phylogeny & macroevolutionary models. Do not expect Pete to be in a good mood if the Cubs have lost, though....

#####Links

- [Email Pete](mailto:pwagner16@unl.edu)
- [Pete's Science Extras](https://sites.google.com/site/peterwagnersscienceextras/)
- [Github Profile: PeterJWagner3](https://github.com/PeterJWagner3)
...
![*This Guy Really Likes Echinoderms*](files/Davey_fossils_AMNH.jpg){#id .class width=30% height=30%}
...
![*Laura Soul*](files/laura_soul.jpg){#id .class width=25% height=25%}
...
![*David Bapst in 2012*](files/dwbapst_in_2012.png){#id .class width=40% height=40%}
...
Rachel is a postdoctoral researcher at ETH Zürich interested in phylogenetic models that incorporate information from the rock and fossil records. 

- [Email Rachel](mailto:rachel.warnock@bsse.ethz.ch) 
